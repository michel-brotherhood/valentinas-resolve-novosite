...
export const Header = () => {
  ...
  return (
    <>
      <header className={`top-0 z-50 ${isHomePage ? 'absolute w-full bg-transparent' : 'sticky bg-gradient-to-b from-black to-black/95 backdrop-blur-sm shadow-lg shadow-primary/5'}`}>
