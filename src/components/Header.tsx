  ...
  return (
    <header className="bg-gradient-to-b from-black to-black/95 backdrop-blur-sm sticky top-0 z-50 shadow-lg shadow-primary/5">
      <div className="container mx-auto px-4 py-3">
        ...
        <div 
          ref={menuRef}
          className={`fixed top-0 right-0 h-full w-[280px] bg-gradient-to-b from-black to-black/95 z-50 md:hidden transform transition-transform duration-300 ease-out ${
