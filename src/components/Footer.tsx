      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 flex flex-col items-center md:items-start">
              ...
              <li>
                <Link to="/termos-de-uso" className="text-sm text-white/70 hover:text-primary transition-colors">
                  Termos de Uso
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 pb-20 border-t border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <p className="text-xs text-white/40 text-center md:text-left md:col-start-4">
              Desenvolvido por{" "}
              <a 
